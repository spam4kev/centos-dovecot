...
sed -i 's/#relayhost = \[gateway.my.domain\]/relayhost = smtp.verizon.net:587/' /etc/postfix/main.cf
...
echo "smtp.verizon.net:587 dovecot1:$(openssl rand -base64 32)" > /etc/postfix/sasl_passwd
